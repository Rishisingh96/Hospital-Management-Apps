...
<body>
	...
	<div class="container p-5">
		<p class="text-center fs-3">Admid Dashboard</p>
		...
		<%
		/* DoctorDao dao = new DoctorDao(DBConnect); */
		%>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="card paint-card" data-bs-toggle="modal"
					...
					<!-- data-bs-toggle="modal" data-bs-target="#exampleModal" this is for Model show popop  -->
					<div class="card-body text-center text-success">
							...
							<form action="../addSpecialist" method="post">
								<div class="form-group">
									<label>Enter Specialist Name</label> <input type="text"
										name="specNem" class="form-control">
								</div>
