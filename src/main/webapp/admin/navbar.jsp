...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"> <i
			class="fas fa-clinic-medical"></i> Medical Home
		</a>
			...
			<form class="d-flex">
				<div class="btn-group">
						<button type="button" class="btn btn-danger dropdown-toggle"
							data-bs-toggle="dropdown" aria-expanded="false">
							<i class="fa-solid fa-user-large"></i> ${doctorObj.fullName}</button>
...
</nav>"  write and Edit my Dropdown show interactive professional  beautiful dropdown dashboard navbar  -->
